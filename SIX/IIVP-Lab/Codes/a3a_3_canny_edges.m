...
ORIGINAL_IMAGE=imread('building.jpg');  
...
subplot(3, 2, 2), imshow(derivative_x);
title('X derivative');
subplot(3, 2, 3), imshow(derivative_y);
title('Y derivative');
subplot(3, 2, 4), imshow(GRADIENT);
title('Gradient image');
subplot(3, 2, 5), imshow(non_max);
title('Image after Non Maxima supression');
subplot(3, 2, 6), imshow(post_hysteresis);
